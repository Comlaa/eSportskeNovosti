...
namespace ESN_Api.Migrations
{
    ...
    [Migration("20220103110523_Password-Properties")]
            ...
            modelBuilder.Entity("ESN_Api.ESN_Api.dal.Domain.Gender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(8873),
                            Name = "Male"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 1, 2, 18, 0, 0, 0, DateTimeKind.Utc),
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(8876),
                            Name = "Female"
                        });
                });
            ...
            modelBuilder.Entity("ESN_Api.ESN_Api.dal.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 1, 2, 18, 0, 0, 0, DateTimeKind.Utc),
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(9230),
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 1, 2, 18, 0, 0, 0, DateTimeKind.Utc),
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(9233),
                            Name = "Editor",
            ...
            modelBuilder.Entity("ESN_Api.ESN_Api.dal.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GenderId = 1,
                            Lastname = "",
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(9472),
                        ...
                        new
                        {
                            ...
                            GenderId = 1,
                            Lastname = "",
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(9476),
                            PasswordHash = "ExhCoLc0RVU6e1K2veoRh6dUP4FRE2uyFXAkQrsPYKc=",
                            PasswordSalt = "ohIp8ucWEgzGRvqMbu3InQ==",
                            Username = "mobile"
                        },
                        new
                        {
                            ...
                            GenderId = 1,
                            Lastname = "",
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 405, DateTimeKind.Utc).AddTicks(9477),
                            PasswordHash = "ExhCoLc0RVU6e1K2veoRh6dUP4FRE2uyFXAkQrsPYKc=",
                            PasswordSalt = "ohIp8ucWEgzGRvqMbu3InQ==",
                            Username = "korisnik"
                        });
            ...
            modelBuilder.Entity("ESN_Api.ESN_Api.dal.Domain.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 1, 3, 11, 5, 23, 406, DateTimeKind.Utc).AddTicks(4311),
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 406, DateTimeKind.Utc).AddTicks(4311),
                            RoleId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 1, 3, 11, 5, 23, 406, DateTimeKind.Utc).AddTicks(4315),
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 406, DateTimeKind.Utc).AddTicks(4315),
                            RoleId = 1,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 1, 3, 11, 5, 23, 406, DateTimeKind.Utc).AddTicks(4316),
                            ModifedAt = new DateTime(2022, 1, 3, 11, 5, 23, 406, DateTimeKind.Utc).AddTicks(4316),
                            RoleId = 3,
                            UserId = 3
                        });
                });
